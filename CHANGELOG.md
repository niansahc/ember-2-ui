...
* **chat:** remove mock fallback, surface failures honestly ([#41](https://github.com/niansahc/ember-2-ui/issues/41)) ([926a821](https://github.com/niansahc/ember-2-ui/commit/926a821952b35ce08e4dd808f8d6beeecf8bcb7e))
...
* **settings:** reload vault-scoped state after a developer vault swap ([#42](https://github.com/niansahc/ember-2-ui/issues/42)) ([0355694](https://github.com/niansahc/ember-2-ui/commit/0355694362a101e1dfca6ad28959f9c4ff695f99))


### Miscellaneous Chores

* release 0.18.0 ([835dd40](https://github.com/niansahc/ember-2-ui/commit/835dd4059597230640aa364ab7d5da7494bc7f61))
...
* add business hours push protection hook and GitHub Actions check ([1610b6f](https://github.com/niansahc/ember-2-ui/commit/1610b6f1c07b66af9926b2b238417406763b3506))
...
* **appearance:** add font scale, density, and reduced-motion prefs ([3528c1f](https://github.com/niansahc/ember-2-ui/commit/3528c1ffc641414c8ddfd11c858b6c510639b4d2))
* **chat:** personalized time-of-day greeting for returning users ([7287381](https://github.com/niansahc/ember-2-ui/commit/72873819d68c155e7a11c32da9f8fd4cec7bad58))
...
* **packs:** full decorative pass — Hearth halos, Hacker brackets, Clean restraint ([f236b0c](https://github.com/niansahc/ember-2-ui/commit/f236b0c18e9847670d3c89fa084cf703040c2281))
...
* **service-status:** surface shutdown errors + visible Restart label ([#9](https://github.com/niansahc/ember-2-ui/issues/9)) ([172eb17](https://github.com/niansahc/ember-2-ui/commit/172eb178c16199dbc9f8ed5eb89bc8a174cecc13))
* **settings:** add Appearance tab with style-pack selector + MVP pack overrides ([8555abd](https://github.com/niansahc/ember-2-ui/commit/8555abdf23a846c521503bfd4fe04f6b6bf2661b))
...
* **settings:** add context length control ([22d62f5](https://github.com/niansahc/ember-2-ui/commit/22d62f5126178910311be7c6f1cfa2dbc238661c))
...
* **settings:** reorder General tab — models first, then style, then theme ([0d6ac4f](https://github.com/niansahc/ember-2-ui/commit/0d6ac4fce754a660935b88412c01bd462c28c5b8))
...
* **tokens:** add typography + spacing + motion + status tokens; bundle self-hosted fonts ([85284c4](https://github.com/niansahc/ember-2-ui/commit/85284c48964c0b51cf8ccca90ca862edff899d9d))
* **ui:** add image preview, vision processing indicator, and source attribution ([b403fc2](https://github.com/niansahc/ember-2-ui/commit/b403fc241b1db988754d8fdd806066a551e88476))
...
* **ui:** add per-conversation bare mode and vault toggles to chat header ([e24367e](https://github.com/niansahc/ember-2-ui/commit/e24367e98bbf57d998d45c66d7d7887bb5bb89b4))
...
* **ui:** re-enable ask-first toggle in Settings (ADR-034 backend live) ([#8](https://github.com/niansahc/ember-2-ui/issues/8)) ([58ef7c3](https://github.com/niansahc/ember-2-ui/commit/58ef7c3ac7d9fb906dfcca27ee34ef34f7ca4ad7))
...
* **ui:** rework top bar with feature status icons ([b6c0c46](https://github.com/niansahc/ember-2-ui/commit/b6c0c46706adcd43d4cde1b001e394f190e7ca65))
...
* **ui:** swap bare mode icon to flame/X toggle ([d40beb7](https://github.com/niansahc/ember-2-ui/commit/d40beb7ed6337e15c8e16db40a5248b7bc49deed))
...
* **ui:** wire ask-first settings toggle to backend ([dc08705](https://github.com/niansahc/ember-2-ui/commit/dc087057c2e869c9d6558fd06518a4a4bec9764e))
* **ui:** wire launch installer button and vault storage display ([466d8cb](https://github.com/niansahc/ember-2-ui/commit/466d8cb37f75abb153470feafb2f6534e79d10a8))
...
* **header:** remove redundant bare-mode × feature icon ([#10](https://github.com/niansahc/ember-2-ui/issues/10)) ([3169aec](https://github.com/niansahc/ember-2-ui/commit/3169aeca40bf4ac2a442d382220a5587e412d37f))
...
* **packs:** correct lodestone + vault-path selectors in hacker/hearth ([71f265c](https://github.com/niansahc/ember-2-ui/commit/71f265ce610166fb005133f76ea0a9ba65298091))
...
* **settings:** inject private_vault as swap option in developer tab ([fc8e2c3](https://github.com/niansahc/ember-2-ui/commit/fc8e2c3fd5f561d3a47d3fdb087a63d249d4b425))
...
* **tests:** add 1 retry to Playwright config for connection pool flakes ([fbb67e1](https://github.com/niansahc/ember-2-ui/commit/fbb67e108210251042655733729172cb772620c2))
...
* **tests:** update tests for always-visible toggles and removed dead code ([edd6d36](https://github.com/niansahc/ember-2-ui/commit/edd6d36005b8e94530cf56ba571e4cd1f5aa26fa))
* **test:** update stale tests for v0.16.0 UI changes ([d2a4552](https://github.com/niansahc/ember-2-ui/commit/d2a4552cd0cd3a7d591d16cc84f8463234ce43b7))
...
* **ui:** align source attribution badges with backend response headers ([efda63d](https://github.com/niansahc/ember-2-ui/commit/efda63d271cd95cf9695f3fa065e08a837bd940c))
...
* **ui:** bare mode in features panel, vault toggle location, bare mode icon condition ([84dedc8](https://github.com/niansahc/ember-2-ui/commit/84dedc8736afda7ee4425219295764566ddc1106))
* **ui:** collapse mobile header into single row at 360px ([#7](https://github.com/niansahc/ember-2-ui/issues/7)) ([d7a1d6a](https://github.com/niansahc/ember-2-ui/commit/d7a1d6a91d38f54956a521d85364586e4603231d))
...
* **ui:** correct bare mode toggle visibility condition ([97d8cb9](https://github.com/niansahc/ember-2-ui/commit/97d8cb98b7f08e6560b4760c53e84b50f6df2af0))
* **ui:** CSP + auth fixes for v0.17.1; backend-down test skip helper ([#11](https://github.com/niansahc/ember-2-ui/issues/11)) ([8fd0315](https://github.com/niansahc/ember-2-ui/commit/8fd031593cbfccc33352311d62b205654a370deb))
...
* **ui:** lock autonomous search toggle ON and remove ask-first icon ([9b09b3e](https://github.com/niansahc/ember-2-ui/commit/9b09b3e91378b21209fe7da06cbe3fe4250f8d6a))
...
* **ui:** remove global gates, always-visible per-conversation toggles, source attribution badges ([2f6fd24](https://github.com/niansahc/ember-2-ui/commit/2f6fd243c2c6dcf66a9d11ab802336f04720ba85))
...
* **ui:** require 2 consecutive health failures before red dot, add amber/slow state ([94c8150](https://github.com/niansahc/ember-2-ui/commit/94c81507099bf5a63df7c8f9facbd725bb888aaa))
...
* **ui:** status dot tooltip, model dot removal, icon spacing, deviation icon, pref persistence wiring ([47d0033](https://github.com/niansahc/ember-2-ui/commit/47d0033c2dee9ad528ca2b49a39007484e3ec43c))
...
* **ui:** tooltip clipping, service status redesign, memory toggle wording confirm ([ab5f326](https://github.com/niansahc/ember-2-ui/commit/ab5f3266a53c192e47be012f98f46400cc24e75a))
...
* vite proxy port + Chat greeting recompute on prefs load ([ff04994](https://github.com/niansahc/ember-2-ui/commit/ff04994d2596dd26ddaf0ee0e5fac120e08eb971))
...
* **chat:** memoize last-assistant index across streaming renders ([c6d8f19](https://github.com/niansahc/ember-2-ui/commit/c6d8f19468cf7f8ac488c9e34359bd8afb29be4c))
